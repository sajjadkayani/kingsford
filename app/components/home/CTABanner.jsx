  ...
  return (
    <section className={styles.cta} aria-labelledby="cta-heading">
      <div className={styles.inner}>
        ...
        <h2 id="cta-heading" className={`display-heading ${styles.title}`}>
          Ready to build your <em>dream bed?</em>
        </h2>

        <p className={styles.sub}>
          Get an instant quote in under 2 minutes. No sign up. No sales calls.
          Just your perfect bed.
        </p>
