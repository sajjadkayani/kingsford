...
export default async function HomePage() {
  ...
  const chesterfield = categories.find((c) => c.slug === "chesterfield");

  return (
    <>
      <Hero />
      {/* Listing 1 — Ottoman Beds */}
      <CategorySpotlight category={chesterfield} index={0} />
      <WhyUs />

      {/* Listing 1 — Ottoman Beds */}
      <CategorySpotlight category={ottoman} index={1} />

      <HowItWorks />

      {/* Listing 2 — Wingback Beds */}
      <CategorySpotlight category={wingback} reversed index={2} />

      {/* Full carousel — all beds */}
      <FeaturedBeds categories={categories} />

      {/* Listing 3 — Divan Beds */}
      <CategorySpotlight category={divan} index={3} />
